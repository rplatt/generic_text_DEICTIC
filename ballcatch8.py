#
# This is a tabular version of ballcatch that is optimized to be adapted for neural networks.
#
#
import gym
import numpy as np
...
#    update_target()
    ...
    for t in range(max_timesteps):
        ...
        if t > learning_starts and t % train_freq == 0:
            ...
            actionsTiled = np.tile(np.reshape(actionsTiled,[batch_size,num_deictic_patches,1]),[1,1,num_cascade])
