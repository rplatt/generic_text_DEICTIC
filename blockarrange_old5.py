#
# Cascaded DQN version of blockarrange.
#
# Adapted from blockarrange4.py
#
# Results: This version of things seems to work pretty well. It should eventually converge
#          to an avg reward of ~10. But, I've found that this code is generally surprisingly
#          finicky. It may not always converge. But, when it does converge, it is generally
#          stable.
#
#          -- It is sensitive to train_freq and batch_size. I currently have it at
#             batch_size=64 and train_freq=2, but I've seen it work well with batch_size=128
#             and train_freq=8.
#
#          -- Also, it seems that using the cascade helps.
#
#          -- Changing the reward to +10=success, 0=fail also helps compared to -1 on every step.
#
#          -- 
#
import gym
