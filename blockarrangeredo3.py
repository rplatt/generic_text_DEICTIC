#
# This version of the code explores the three-block version of blockarrangeredo2.py
# using the same algorithm as used in blockarrangeredo2.py
#
# Adapted from blockarrangeredo2.py
#
# Results: Doesn't work very well. I suspect this is due to insufficient information
#          in the state representation. In blockarrangeredo4.py, I plan to augment
