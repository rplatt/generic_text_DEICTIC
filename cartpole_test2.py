#
# This version of the code can be adapted to a one-hot representation and/or to mlutiple different "basic"environments
# I think that in the frozenlake env'ts, it is a huge help to set r=-1 on all timesteps except the last rather than to use the default reward structure.
#
import gym
import numpy as np
