#
# This version solves TestRob2Env gridworld problem using a cnn representation.
# The agent gets r=-1 on all steps except the last. Starts in a random position.
#
import gym
import numpy as np
