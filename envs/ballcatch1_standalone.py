...
class BallCatch:
    ...
    def __init__(self):
        ...
        self.state = None
        self.directionofmotion = None # 0 (left) or 1 (right)
        self.slopeofmotion = None # num of vert drops before the next horizontal move
        self.slopecount = None # used to determine when to move horizontally
        self.reset()
    ...
    def reset(self):
        ...
        # set characteristics of ball motion
        self.directionofmotion = np.random.randint(2)
        self.slopeofmotion = np.random.randint(1,6)
        self.slopecount = 0
