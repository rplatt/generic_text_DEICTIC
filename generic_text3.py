#
# Adapted from generic_text2.py. 
#
# In this version, I'm introduced a two-pathway network structure. Not clear
# that it helps. It could be that a larger number of hidden nodes in the conv
# layers have the same effect. In principle, these two architectures should be 
# the same (I think?)
#
#
# Results:
#
#        -- I notice that going from 'SAME' to 'VALID' in the convolution2d layers
#           seems to give more consisent results for ballcatch 4x4x2. Don't see the 
#           same benefit in 4x4x4...
#
#        -- After introducing the two-pathway version, I think I might be getting faster
#           convergence to between 0.7 and 0.9 for ballcatch for 3x3x4. But, I think
#           I see similar benefits to just increasing the num of hidden nodes in the conv 
#           layer from 16 to 32 ...
#
#        -- On ghostevade w/ 3x3x4, I see conv to ~50 or ~60. No meaningful difference between
#           one pathway w/ 32 hidden nodes and two pathways w/ 16 hidden nodes each.
#
#        -- BUT: I notice that you are not always guaranteed convergence. Someimes, 
#                the DNN version of things just fails...
#
import gym
import numpy as np
import time as time
