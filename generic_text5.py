...
#
# In this version, I'm exploring creating additional per-step experiences using rotations. This
# only works in domains with the right type of symmetry.
#
# Results: I think this helped, for multi-ghost-evade, but only a bit. 
#          I tried other variations, but couldn't get
#          anything to help more than just augmenting the experiences.
#
#          One thing that probably helps is increasing batch size. I increased
#          it to 1024 w/ a 6x6x2 window and I thought I saw more consistent 
#          but the max was not much higher.
#
import gym
import numpy as np
import time as time
