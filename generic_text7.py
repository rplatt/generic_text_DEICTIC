...
#
# In this version, I'm planning to explore a monte carlo version of the linear fn
# approx. After reading the sutton book, I realize that we need linear fn approx +
# monte carlo in order to guarantee convergence. With an appropriately diminishing
# step size, this should converge to global optimality.
#
# Results: I'm not *absolutely* sure there are no bugs here, but MC seems to converge
#          pretty slowly compared w/ the standard bellman approach. I have not really
#          investigated this fully, but it is hard to see how this will be very competitive
#          with the bellman methods.
#
import gym
import numpy as np
import time as time
