#
# Adapted from ballcatch10.py. Straight DQN version.
#
# Performance is good on ballcatch1 and ghostevade1. For multighost (w/ four ghosts),
# it tops out at ~10 to ~15. This level of performance is similar to what I see
# in deneric_text_DQN3.py.
#
# I notice that generic_text4.py w/ a single 8x8x2 window seems to work a bit better.
# That could be b/c generic_text4.py uses a 2-channel input whereas this version
# uses a 1-channel image.
#
#
import gym
import numpy as np
