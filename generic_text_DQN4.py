#
# Adapted from generic_text_DQN3.py. 
#
# This version uses a two-channel observation (just like the deictic version)
# instead of the standard one-channel image.
#
# Results: this version can get as high as 27 for the four-ghost env. That is
# in contrast to a high of 15 for the one-channel observation version (generic_text_DQN3)
#
import gym
import numpy as np
import time as time
