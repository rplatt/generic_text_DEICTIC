#
# This version combines double-q with deitic cascaded same-next-patch. 
#
# Results
#   -- update period = 500 -> seems to max out in the 60s compared to standard which 
#        maxes out in the 100s
#   -- update period = 100 -> same sort of behavior: seems to max out in the 60s...
#   -- it seems that double-q has a negative effect on the max value reached for any
#        period larger than 1 time step. Not yet sure why this is...
# 
import gym
import numpy as np
import time as time
