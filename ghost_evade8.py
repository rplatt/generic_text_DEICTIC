#
# In this version, I compare performance of MLP vs CNN for various different architectures.
#
# Results:
# 
#   -- I find that none of the MLP designs seem to work very well. I suspect that
#      the MLP has problems w/ multi-channel image input for some reason...
# 
#   -- The CNN: convs=[(16,3,1)], hiddens=[16] seems to work well.
#   -- The CNN: convs=[(16,2,1)], hiddens=[16] also seems to work well.
#   -- The CNN: convs=[(16,2,1)], hiddens=[32] seems to work just as well (perhaps a bit worse at convergence?)
# 
import gym
import numpy as np
import time as time
