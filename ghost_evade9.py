#
# In this version, I've implemented everything required for double-q. But, this
# version is still running regular DDQN. I'm going to double-q in ghost_evade10.py...
# 
# 
import gym
import numpy as np
