#
# This is the first working version of the code that uses MNIST numbers instead
# of binary ones and zeros. Here, there is an 8x8 grid where each cell contains
# a 28x28 MNIST numeral (actually a (8x28)x(8x28) grid). The procedure is exactly 
# the same as before except now the neural network takes an 84x84 image resized 
# to 10x10 as input. Numeral shapes are sampled randomly at the beginning of each 
# episode.
#
# Adapted from blockarrangeredo2.py
#
# Results: seems to work just fine for 1/1 or 1000/32. Performance is just about
# the same as it was in blockarrangeredo2.py
#
import gym
import numpy as np
import time as time
