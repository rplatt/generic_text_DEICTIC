#
# Hi-res version of numbersarrange1.py. Here, the agent can pick/place on a more
# dense grid of locations -- not just on integer numeral placements.
#
# Adapted from numbersarrange1.py
#
# I've redone this code a couple of times now and this is my final version. 
#
# Works for: 1000/10, stride=28, descShape=10,10
# Works for: 1000/10, stride=14, descShape=10,10. But, stride=14 works better w/ descShape=14,14.
# Works for: 1000/10, stride=7, descShape=15,15, but just barely. It took until
#            step 4k before learning anything (without numeral randomization).
# 
# Things improve when you don't randomize the numerals...
#
import gym
import numpy as np
import time as time
...
import envs.numbersarrange_env3 as envstandalone
...
#    obs = env.reset()
    obs = env.reset(2) # parameter denotes stride used in randomly initializing numbers on grid
