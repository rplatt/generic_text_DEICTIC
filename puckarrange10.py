#
# This one can handle blocks with 0/45/90/135 orientations
#
# Adapted from puckarrange9.py
#
# Results: works down to at least 7
#
#
import sys as sys
import gym
...
import envs.puckarrange_env10 as envstandalone
