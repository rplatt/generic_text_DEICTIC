#
# This version can use a two-stage hierarchy: NoRot followed by Rot. Check out the
# useHierarchy flag.
#
# Adapted from puckarrange11.py
#
# Results: Looks like it works! However, the hierarchy does slow down learning
#          to some degree. This is especially evident when training from scratch.
#
#
import sys as sys
import gym
...
import envs.puckarrange_env12 as envstandalone
