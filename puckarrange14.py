# This version is virtually the same as puckarrange12.py except that I've changed
# the learning rates and added a softmax-greedy action selection strategy.
# 
#
# Adapted from puckarrange12.py
#
# Results: I think I'm finding that setting the learning rate for NoRot twice as large
#          as that for Rot helps the hierarchy converge. I might even converge 
#          faster than noHierarchy...
#
#
import sys as sys
import gym
...
##        qCurrExp = np.exp(qCurr/0.05)
#        qCurrExp = np.exp(qCurr/0.01)
