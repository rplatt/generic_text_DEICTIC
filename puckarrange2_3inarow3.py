#
# In this version, I took out the replay buffer and implemented direct q-learning.
# This version does not use the state-value estimates -- it directly does q-learning.
#
#
# Adapted from puckarrange2_3inarow1.py
#
# Results: I think the direct q-learning improves convergence somewhat.
#
#
import sys as sys
import gym
