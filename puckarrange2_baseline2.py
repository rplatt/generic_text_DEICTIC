#
# In this version, I want to develop a baseline against which to compare puckarrange2.py
#
...
#            outputs=[td_error, obs_t_input.get(), target_input.get()],
            outputs=[q_t_raw, targetTiled, errors],
...
#            targets = rewards + (1-dones) * gamma * V[states_tp1] # Calculate target
