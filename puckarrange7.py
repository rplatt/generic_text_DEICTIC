#
# Here, I update the action descriptors with different orientations. In this
# version, I don't actually rotate the disks.
#
# Adapted from puckarrange6.py
#
# Results: 
#
#
...
import envs.puckarrange_env7 as envstandalone
