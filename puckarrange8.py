#
# Here, I fixed a bug that was preventing me from rotating the objects properly
# in puckarrage_env8.py
#
# Adapted from puckarrange7.py
#
# Results: 
#
#
...
import envs.puckarrange_env8 as envstandalone
