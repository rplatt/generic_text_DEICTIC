#
# Here, I get 0/90 version of blocks working. Only two orientations.
#
# Adapted from puckarrange8.py
#
# Results: works for different resolutions. Tested down to 7
#
#
import sys as sys
import gym
...
import envs.puckarrange_env9 as envstandalone
