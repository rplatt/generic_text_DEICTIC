# 
# This version extendes the _encode_sample function even more to allow for 
# next-state, next-image, and next-place-patch
#
#
...
#        obses_t, actions, rewards, obses_tp1, dones = [], [], [], [], []
        states_t, actions, rewards, states_tp1, images_tp1, placeMemory_tp1, dones = [], [], [], [], [], [], []
        for i in idxes:
...
#            obses_tp1.append(np.array(obs_tp1, copy=False))
            ...
            placeMemory_tp1.append(np.array(obses_tp1[2], copy=False))
            dones.append(done)
#        return np.array(obses_t), np.array(actions), np.array(rewards), np.array(obses_tp1), np.array(dones)
        return np.array(states_t), np.array(actions), np.array(rewards), np.array(images_tp1), np.array(states_tp1), np.array(placeMemory_tp1), np.array(dones)
